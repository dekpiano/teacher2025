...
<div class="row g-4">
    ...
    <div id="page-loader-wrapper">
        <div class="loader-container">
            ...
            <div class="loader-percentage text-warning">0%</div>
        </div>
        <div class="loader-time mt-2 mb-1">0.00s</div>
        <div class="loader-text fw-bold text-uppercase text-warning">กำลังประมวลผลข้อมูลเรียนซ้ำ...</div>
        <div class="mt-1 small text-muted">ระบบกำลังรวบรวมรายชื่อและจัดเตรียมบันทึกคะแนน</div>
    </div>
            ...
            <div class="card-header border-bottom d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <select name="check_room" id="check_room" class="form-select form-select-sm w-auto border-secondary">
                        <option value="all" <?= ($Room == 'all' ? 'selected' : '') ?>>ทั้งหมด ทุกห้องเรียน</option>
                        <?php
