...
<head>
    ...
    ?>
    <title><?= $isScout ? 'แบบบันทึกผลการจัดกิจกรรมลูกเสือ - เนตรนารี' : 'แบบบันทึกผลการจัดกิจกรรมชุมนุม' ?> - <?= esc($formattedClubName) ?></title>
    ...
    <style>
        ...
        * {
        ...
        /* หน้า 1 (ปกและอนุมัติ): กระจายเนื้อหาแนวตั้งให้เต็มหน้าและสมดุล 4 ทิศทางอย่างลงตัว */
        .page-cover {
...
<body>
    ...
    <div class="no-print-bar">
        <div class="d-flex align-items-center flex-wrap gap-2">
            <button onclick="printSpecificMode('all')" class="btn-print-action" title="สั่งพิมพ์เอกสารทั้งหมด (สำหรับ Windows / Google Chrome)">
                <i class="bi bi-printer-fill"></i> สั่งพิมพ์ทั้งหมด
            </button>
            <button onclick="printSpecificMode('portrait')" class="btn-print-action btn-portrait" title="พิมพ์เฉพาะหน้าแนวตั้ง (หน้า 1, 2, 4, 5) แนะนำสำหรับ Mac/iOS Safari">
                <i class="bi bi-file-earmark-text"></i> พิมพ์รายงาน (แนวตั้ง)
            </button>
            <button onclick="printSpecificMode('landscape')" class="btn-print-action btn-landscape" title="พิมพ์เฉพาะหน้าตารางบันทึกเวลาเรียน (หน้า 3) เป็นแนวนอน">
                <i class="bi bi-table"></i> พิมพ์เวลาเรียน (แนวนอน)
            </button>
            <button onclick="window.close()" class="btn-close-action">
                <i class="bi bi-x-circle"></i> ปิดหน้าต่าง
            </button>
        </div>
        <div style="font-size: 11.5pt; color: #d1d5db;" class="d-none d-lg-block text-end">
            <i class="bi bi-apple me-1"></i> <span class="text-warning">ผู้ใช้ Mac / iPad / iOS:</span> หากพิมพ์รวมแล้วตารางเวลาเรียนถูกตัดขอบ ให้กดปุ่ม <strong>"พิมพ์รายงาน (แนวตั้ง)"</strong> และ <strong>"พิมพ์เวลาเรียน (แนวนอน)"</strong> แยกกันครับ
        </div>
    </div>
    ...
    <div class="page-wrapper">
        ...
        <div class="printable-page portrait-page page-cover text-center">
            ...
            <div class="text-center doc-header-block">
                ...
                <div class="doc-header-suborg">สำนักงานเขตพื้นที่การศึกษามัธยมศึกษานครสวรรค์</div>
            </div>
            ...
            <table class="cover-info-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="cover-info-value"><?= esc($studyTimeInfo['formatted_level'] ?? ('มัธยมศึกษาตอน' . $club->club_level)) ?></td>
                    </tr>
                    <tr>
                        <td class="cover-info-label">ภาคเรียน / ปีการศึกษา</td>
                        <td class="cover-info-value">ภาคเรียนที่ <?= esc($club->club_trem) ?> ปีการศึกษา <?= esc($club->club_year) ?></td>
                    </tr>
                    <tr>
                        <td class="cover-info-label">เวลาเรียนตามเกณฑ์</td>
                        <td class="cover-info-value"><?= esc($studyTimeInfo['study_time_per_week_label'] ?? '1 คาบ/สัปดาห์') ?> (รวมตลอดภาคเรียน <?= esc($studyTimeInfo['total_study_time_label'] ?? '20 ชั่วโมง') ?>)</td>
                    </tr>
                    <tr>
            ...
            <div class="approval-container">
                <div class="fw-bold text-start mb-1" style="font-size: 15pt; text-decoration: underline;">
                ...
                <div class="approval-box">
                    ...
                    <div class="row justify-content-center mb-2">
                        <div class="col-12 text-center signature-line-group">
                            ...
                            <div class="sig-name fw-bold" style="padding-left: 0; font-size: 14.5pt; margin-top: 2px;">( <?= esc($activityHeadName) ?> )</div>
                            <div style="font-size: 14pt; font-weight: 500;"><?= esc($headRoleLabel) ?></div>
                            <div class="text-muted" style="padding-left: 0; font-size: 12pt;">วันที่ ...... เดือน ............................ พ.ศ. ...........</div>
                        </div>
                    </div>

                    <!-- 2. รองลงมา ซ้าย-ขวา: ผู้กำกับลูกเสือ / ครูที่ปรึกษา -->
                    <div class="row gx-2 justify-content-center mb-2">
                        <?php if (count($advisorNamesList) === 1): ?>
                            <div class="col-12 text-center signature-line-group">
                                <div>ลงชื่อ<span class="sig-dots" style="width: 180px;"></span></div>
                                <div class="sig-name fw-bold" style="padding-left: 0; font-size: 14.5pt; margin-top: 2px;">( <?= esc($advisorNamesList[0]) ?> )</div>
                                <div style="font-size: 14pt; font-weight: 500;"><?= esc($evaluatorRoleLabel) ?></div>
                                <div class="text-muted" style="padding-left: 0; font-size: 12pt;">วันที่ ...... เดือน ............................ พ.ศ. ...........</div>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="col-6 px-2 text-center signature-line-group">
                                ...
                                <div class="sig-name fw-bold" style="padding-left: 0; font-size: 14.5pt; margin-top: 2px;">( <?= esc($advName) ?> )</div>
                                <div style="font-size: 14pt; font-weight: 500;"><?= esc($evaluatorRoleLabel) ?><?= count($advisorNamesList) > 1 ? ' (' . ($idx + 1) . ')' : '' ?></div>
                                <div class="text-muted" style="padding-left: 0; font-size: 12pt;">วันที่ ...... เดือน ............................ พ.ศ. ...........</div>
                            </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    ...
                    <div class="row gx-2 justify-content-center mb-2">
                        <div class="col-6 px-2 text-center signature-line-group">
                            <div>ลงชื่อ<span class="sig-dots" style="width: 160px;"></span></div>
                            <div class="sig-name fw-bold" style="padding-left: 0; font-size: 14.5pt; margin-top: 2px;">( <?= esc($measurementHeadName) ?> )</div>
                            <div style="font-size: 14pt; font-weight: 500;">หัวหน้าฝ่ายวัดและประเมินผล</div>
                            <div class="text-muted" style="padding-left: 0; font-size: 12pt;">วันที่ ...... เดือน ............................ พ.ศ. ...........</div>
                        </div>
                        <div class="col-6 px-2 text-center signature-line-group">
                            <div>ลงชื่อ<span class="sig-dots" style="width: 160px;"></span></div>
                            <div class="sig-name fw-bold" style="padding-left: 0; font-size: 14.5pt; margin-top: 2px;">( <?= esc($activityDevHeadName) ?> )</div>
                            <div style="font-size: 14pt; font-weight: 500;">หัวหน้างานกิจกรรมพัฒนาผู้เรียน</div>
                            <div class="text-muted" style="padding-left: 0; font-size: 12pt;">วันที่ ...... เดือน ............................ พ.ศ. ...........</div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center mb-1">
                        <div class="col-12 text-center signature-line-group" style="margin-bottom: 0;">
                            <div>ลงชื่อ<span class="sig-dots" style="width: 180px;"></span></div>
                            <div class="sig-name fw-bold" style="padding-left: 0; font-size: 14.5pt; margin-top: 2px;">( <?= esc($deputyDirectorAcademicName) ?> )</div>
                            <div style="font-size: 14pt; font-weight: 500;">รองผู้อำนวยการกลุ่มบริหารวิชาการ</div>
                            <div class="text-muted" style="padding-left: 0; font-size: 12pt;">วันที่ ...... เดือน ............................ พ.ศ. ...........</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="approval-box">
                    <div class="mb-2 fw-bold" style="font-size: 14.5pt;">
                        <span class="me-4">&#9744; อนุมัติ</span>
                        <span class="me-4">&#9744; ไม่อนุมัติ</span>
                        <span class="fw-normal">เนื่องจาก ........................................................................................</span>
                    </div>
                    <div class="signature-line-group mt-2 text-center">
                        <div>ลงชื่อ<span class="sig-dots" style="width: 200px;"></span></div>
                        <div class="sig-name fw-bold" style="padding-left: 0; font-size: 15pt; margin-top: 2px;">( <?= esc($directorName) ?> )</div>
                        <div style="font-size: 14pt; font-weight: 500;">ผู้อำนวยการโรงเรียนสวนกุหลาบวิทยาลัย (จิรประวัติ) นครสวรรค์</div>
                        <div class="sig-name" style="padding-left: 0; margin-top: 2px; font-size: 12pt;">วันที่ ...... เดือน ............................ พ.ศ. ...........</div>
                    </div>
                </div>
        ...
        <div class="printable-page portrait-page">
            <div class="text-center mb-3">
                ...
                <div class="fw-bold" style="font-size: 16pt;"><?= esc($activityTypeLabel) ?> : <?= esc($formattedClubName) ?></div>
            ...
            <table class="table-official" style="font-size: 15pt;">
                <thead>
                    <tr>
        ...
        <div class="printable-page landscape-page">
            ...
            <div class="text-center mb-1">
                <div class="fw-bold" style="font-size: 16pt;">
            ...
            <table class="table-official landscape-table mb-1">
                <thead>
                    ...
                    ?>
                    <tr>
                        <th rowspan="2" style="width: 28px; font-size: 9.5pt;">เลขที่</th>
                        <th rowspan="2" style="min-width: 155px; font-size: 11pt;" class="text-start ps-2">ชื่อ - นามสกุล</th>
                        <th rowspan="2" style="width: 44px; font-size: 9.5pt;">ชั้น</th>
                        <?php foreach ($schedulesByMonth as $month => $schedulesInMonth): ?>
                            ...
                            ?>
                            <th colspan="<?= count($schedulesInMonth) ?>" style="font-size: 7.5pt;">
                    ...
                    <tr>
                        <?php foreach ($schedulesByMonth as $month => $schedulesInMonth): ?>
                            <?php foreach ($schedulesInMonth as $schedule): ?>
                                <th style="min-width: 17px; font-size: 7pt;"><?= date('d', strtotime($schedule->tcs_start_date)) ?></th>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
                    </tr>
                </thead>
                    ...
                    <?php if (!empty($members)): ?>
                        <?php foreach ($members as $member): ?>
                            <tr>
                                ...
                                <td class="student-name"><?= esc($member->StudentPrefix . $member->StudentFirstName . ' ' . $member->StudentLastName) ?></td>
                                ...
                                ?>
                                    <td class="attendance-mark"><?= ($status === 'มา') ? '✓' : ($status === 'ขาด' ? 'ข' : ($status === 'ลาป่วย' ? 'ป' : ($status === 'ลากิจ' ? 'ก' : '-'))) ?></td>
                                <?php 
                                        endforeach; 
                                    endforeach; 
                                ?>
            ...
            <div style="font-size: 11pt;">
                <span class="fw-bold">หมายเหตุการลงเวลา:</span> ✓ = มาเรียน | ข = ขาดเรียน | ป = ลาป่วย | ก = ลากิจ | เกณฑ์ผ่าน (ผ) = เวลาเรียนไม่น้อยกว่าร้อยละ 80
            </div>
        </div>
        ...
        <div class="printable-page portrait-page">
            <div class="text-center mb-3">
                <div class="fw-bold" style="font-size: 18pt;">รายงานผลการประเมินตามจุดประสงค์</div>
                <div class="fw-bold" style="font-size: 16pt;"><?= esc($activityTypeLabel) ?> : <?= esc($formattedClubName) ?></div>
                <div style="font-size: 15pt;">
                    ระดับชั้น<?= esc($studyTimeInfo['formatted_level'] ?? ('มัธยมศึกษาตอน' . $club->club_level)) ?> 
                    ภาคเรียนที่ <?= esc($club->club_trem) ?> ปีการศึกษา <?= esc($club->club_year) ?>
                    ...
                    <thead>
                        ...
                        <tr>
                            <?php foreach ($club_objectives as $objective): ?>
                                <th style="width: 28px; font-size: 10.5pt;"><?= esc($objective->objective_order) ?></th>
                            <?php endforeach; ?>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($members as $member): ?>
                            <tr>
                                ...
                                <td class="text-start ps-2" style="white-space: nowrap;"><?= esc($member->StudentPrefix . $member->StudentFirstName . ' ' . $member->StudentLastName) ?></td>
            ...
            <?php else: ?>
                <div class="text-center py-4 border my-3" style="font-size: 13pt;">
        ...
        <div class="printable-page portrait-page">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (!empty($objective->objective_description)): ?>
                                            <div class="text-muted" style="font-size: 13.5pt;"><?= esc($objective->objective_description) ?></div>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
            ...
            <div class="mb-3">
                ...
                <table class="table-official text-center" style="font-size: 15pt;">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="fw-bold" style="padding: 6px; font-size: 15pt;"><?= esc($summaryParticipation['totalStudents']) ?> คน</td>
                            <td class="fw-bold text-success" style="padding: 6px; font-size: 15pt;"><?= esc($summaryParticipation['passed']) ?> คน</td>
                            <td class="fw-bold text-danger" style="padding: 6px; font-size: 15pt;"><?= esc($summaryParticipation['failed']) ?> คน</td>
                            <td style="padding: 6px; font-size: 15pt;"><?= esc($summaryParticipation['longAbsence']) ?> คน</td>
                            <td style="padding: 6px; font-size: 15pt;"><?= esc($summaryParticipation['dismissed']) ?> คน</td>
                        </tr>
                    </tbody>
                </table>
            </div>
